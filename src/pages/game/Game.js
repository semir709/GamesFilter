...
const Game = () => {
  ...
  return (
    <div className="game-page-holder mx-5">
      ...
      <div className="game-desc mt-3 mb-5">{parse(data.description)}</div>
        ...
        <div className="row justify-content-between">
          <div className=" col-xl-6 info-game ">
            ...
            <div className="platform-info ">
              ...
              <div>
                {data.platforms.map(({ platform, id }) => {
                  return (
                    <p className="my-2" key={platform.id}>
                      {platform.name}
                    </p>
                  );
                })}
            ...
            <div className="more-info">
              ...
              <a className="d-block" href={data.website} target="_blank">
                {data.name} Website
              </a>
              <a href={data.reddit_url} target="_blank">
                {data.reddit_name} Reddit
              </a>
            </div>
          </div>
